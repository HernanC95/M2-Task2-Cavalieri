...
/////////SE FILTRA EVENTOS SIGUIENTES Y SE LOS AGRUPA EN UN ARRAY
...
function filtrarUpcoming(eventos) {
  const upcomingEventsAux = [];
  for (let i = 0; i < eventos.length; i++) {
    if (validarFechaUpcoming(eventos[i].date,fechaActual)){
      upcomingEventsAux.push(eventos[i]) }
  }
  return upcomingEventsAux;
}
console.log(filtrarUpcoming(eventos))

const upcomingEvents = filtrarUpcoming(eventos)
...
function filtrarCategoriaFF(upcomingEvents) {
  const foodFairAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaFF(upcomingEvents[i].category)){
        foodFairAux.push(upcomingEvents[i]) }
  }
  return foodFairAux;
}
console.log(filtrarCategoriaFF(upcomingEvents))
...
function filtrarCategoriaM(upcomingEvents) {
  const museumAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaM(upcomingEvents[i].category)){
        museumAux.push(upcomingEvents[i]) }
  }
  return museumAux;
}
console.log(filtrarCategoriaM(upcomingEvents))
...
function filtrarCategoriaCP(upcomingEvents) {
  const costumePartyAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaCP(upcomingEvents[i].category)){
        costumePartyAux.push(upcomingEvents[i]) }
  }
  return costumePartyAux;
}
console.log(filtrarCategoriaCP(upcomingEvents))
...
function filtrarCategoriaMC(upcomingEvents) {
  const musicConcertAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaMC(upcomingEvents[i].category)){
        musicConcertAux.push(upcomingEvents[i]) }
  }
  return musicConcertAux;
}
console.log(filtrarCategoriaMC(upcomingEvents))
...
function filtrarCategoriaR(upcomingEvents) {
  const raceAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaR(upcomingEvents[i].category)){
        raceAux.push(upcomingEvents[i]) }
  }
  return raceAux;
}
console.log(filtrarCategoriaR(upcomingEvents))
...
function filtrarCategoriaBE(upcomingEvents) {
  const bookExchangeAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaBE(upcomingEvents[i].category)){
        bookExchangeAux.push(upcomingEvents[i]) }
  }
  return bookExchangeAux;
}
console.log(filtrarCategoriaBE(upcomingEvents))
...
function filtrarCategoriaC(upcomingEvents) {
  const cinemaAux = [];
  for (let i = 0; i < upcomingEvents.length; i++) {
    if (validarCategoriaC(upcomingEvents[i].category)){
        cinemaAux.push(upcomingEvents[i]) }
  }
  return cinemaAux;
}
console.log(filtrarCategoriaC(upcomingEvents))